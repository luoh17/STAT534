...
struct myRegression
{
  ...
  double lml_mc; // log marginal likelihood of the regression -- Monte Carlo integration
  double lml_la; //log marginal likelihood of the regression -- Laplace Approximation
