...
gsl_matrix* getPi(int n, gsl_matrix* x, gsl_matrix* beta) {
	...
	for(i=0;i<n;i++) {
		gsl_matrix_set(x0, i, 0, 1.0); // Intercept
...
// get Hessian for Newton-Raphson
...
// get the gradient for Newton-Raphson
...
// this function implements our own Newton-Raphson
